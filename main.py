        ...
        for ss in sSymbol_list:
            ...
            if Upbit.매수 == False:
                ...
                if Upbit.not_balance_dict != {}:
                    ...
                    for i in list(Upbit.not_balance_dict.copy().keys()):
                ...
                if close > ema12 and ema12 >= ema26:
                    ...
                    if _symbol not in list(Upbit.balance_dict.keys()) and  Upbit.not_balance_dict == {} and _symbol not in Upbit.order_buy_list:
                ...
                # 하락 추세
                if _symbol in list(Upbit.balance_dict.keys()) and _symbol not in Upbit.order_sell_list:
