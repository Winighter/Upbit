    ...
    def min_candle_chart(self): # KRW-BTC
        ...
        if Upbit.매수 == False:
            ...
            if close > ema12 and ema12 >= ema26:
                ...
                if sSymbol not in Upbit.balance_dict.keys() and Upbit.not_balance_dict == {} and _symbol not in Upbit.order_buy_list:
            ...
            # 하락 추세
            if sSymbol in Upbit.balance_dict.keys() and _symbol not in Upbit.order_sell_list:
                sAmount = Upbit.balance_dict[sSymbol]['balance']
